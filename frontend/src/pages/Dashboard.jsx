...
export default function Dashboard() {
  ...
  useEffect(() => {
    // Fetch Profile
    axios.get("http://localhost:5000/api/dashboard/profile", {
      headers: { Authorization: `Bearer ${token}` }
    }).then(res => setProfile(res.data));

    // Fetch Chat History
    axios.get("http://localhost:5000/api/dashboard/chats", {
      headers: { Authorization: `Bearer ${token}` }
  ...
  return (
    <div className="flex">
      ...
      <div className="w-full p-6 space-y-10 bg-gray-100">
        ...
        {/* Report History */}
        <section>
          <h2 className="text-2xl font-bold mb-4">Medical Report History</h2>
